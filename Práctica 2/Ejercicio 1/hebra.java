/**
 *                                 Clase hebra
 * Clase que hereda de Thread e implementa el método run para su uso concurrente
 * @author Jesús Gómez
 * @version 1.0
 * @see Usa_hebra
 * @see Thread
...
public class hebra extends Thread{
    ...
    int iteraciones = 0; // Número de vueltas (único para cada instancia de la clase)
